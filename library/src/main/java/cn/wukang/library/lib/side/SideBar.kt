...
class SideBar : View {
    companion object {
        ...
        private val DEFAULT_INDEX_ITEMS: Array<String> = arrayOf("A", "B", "C", "D", "E", "F", "G", "H",
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val areaLeft: Float = if (mSideBarPosition == POSITION_LEFT) 0.toFloat() else width.toFloat() - mBarWidth - paddingRight.toFloat()
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // draw each item
        var i = 0
        val mIndexItemsLength: Int = mIndexItems.size
        while (i < mIndexItemsLength) {
            ...
            val alphaScale: Int = if (i == mCurrentIndex) 255 else (255 * (1 - scale)).toInt()
    ...
    fun setIndexItems(indexItems: Array<String>) {
