 ...
 * @author wukang
 */
open class ItemTouchBindViewHolder<B : ViewDataBinding>(binding: B, @LayoutRes layoutId: Int, clickListener: RecyclerClickListener, private var listener: ItemViewStateChangeListener)
    ...
    companion object {
         ...
         */
        fun <B : ViewDataBinding> get(binding: B, @LayoutRes layoutId: Int, clickListener: RecyclerClickListener, listener: ItemViewStateChangeListener)
